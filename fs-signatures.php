...
function fs_page_sign ( $atts ) {
    ...
    <form name="register<?=($popup ? "_popup" : "");?>">
        <table border="0">
            ...
            <tr><td class="leftcol"><img src="/wp-content/uploads/2021/02/captcha.png"/></td><td class="rightcol"><input<?=($narrow || $popup) ? " class='smallinput'" : "";?> type="text" name="arithmetic" id="name<?=($popup ? "_popup" : "");?>"></td></tr>
